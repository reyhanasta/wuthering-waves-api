...
import * as userController from "../controllers/userController.js"; // Adjust the path as necessary
...
router.get("/:id", userController.getUserById); // GET /api/users/:id -> Get a single user by ID
router.put("/:id", userController.updateUser); // PUT /api/users/:id -> Update a user by ID
router.delete("/:id", userController.deleteUser); // DELETE /api/users/:id -> Delete a user by ID
